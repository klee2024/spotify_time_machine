class UserAuthenticationController < ApplicationController
  ...
  def create
    ...
    @user.spotify_user_id = params.fetch("query_spotify_user_id")
    @user.access_token = params.fetch("query_access_token")
    @user.refresh_token = params.fetch("query_refresh_token")
